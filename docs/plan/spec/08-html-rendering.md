...
| `Packages/MailCore/Tests/MailHTMLTests/Fixtures/html/tracking-pixels.html` | new | seven `<img>` variants (§5.9) |
...
| `Packages/MailCore/Tests/MailHTMLTests/Fixtures/html/xss-samples.html` | new | 16 numbered attack vectors (§5.9) |
